...
public class CollectionAdjusterHashOhneReferenzAnpassung {

	
	BücherVerwaltung bücherVerwaltung;
	
	
	public CollectionAdjusterHashOhneReferenzAnpassung(BücherVerwaltung myBücherVerwaltung) {
	...
	public void adjustInvolvedCollections(Buch buch) {
		...
		bücherVerwaltung.setAutoren(createAutorHelpSet(buch, bücherVerwaltung.getAutoren()));
		bücherVerwaltung.setVerläge(createVerlagHelpSet(buch, bücherVerwaltung.getVerläge()));
		bücherVerwaltung.setBuchTypen(createBuchTypHelpSet(buch, bücherVerwaltung.getBuchTypen()));
	...
	private Collection<BuchTyp> createBuchTypHelpSet(Buch inputBuch, Collection<BuchTyp> inputList) {
		HashSet<BuchTyp> helpSet = new HashSet<>(inputList);
		helpSet.add(inputBuch.getBuchTyp());
